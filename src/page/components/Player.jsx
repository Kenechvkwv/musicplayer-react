...
function Player({ currentSong, onNext, onPrev }) {
  ...
  return (
    <>
      <div
        className="md:h-[40vh] h-[30vh] w-full rounded-lg bg-center bg-cover mb-3"
      ...
      <div className="flex items-center justify-center gap-3 p-4 bg-gray-200 rounded-lg text-gray-500">
        ...
        >
          <svg
            ...
            width="24"
            height="24"
            className={isShuffle ? "text-green-500" : "text-gray-500"}
            fill="currentColor"
            viewBox="0 0 24 24"
          >
            <path d="m18,6h-2.59c-.53,0-1.04.21-1.41.59l-9.41,9.41h-2.59v2h2.59c.53,0,1.04-.21,1.41-.59l9.41-9.41h2.59v3l4-4-4-4v3Z"></path>
            <path d="m18,16h-1.59l-2.71-2.71-1.41,1.41,2.71,2.71c.37.37.89.59,1.41.59h1.59v3l4-4-4-4v3Z"></path>
            <path d="m7.29,9.71l1.41-1.41-1.71-1.71c-.37-.37-.89-.59-1.41-.59h-3.59v2h3.59l1.71,1.71Z"></path>
          </svg>
        </button>
        ...
        >
          <svg
            ...
            viewBox="0 0 24 24"
          >
            <path d="m16,5H7c-1.1,0-2,.9-2,2v5h2v-5h9v3l5-4-5-4v3Z"></path>
            <path d="m17,17h-9v-3l-5,4,5,4v-3h9c1.1,0,2-.9,2-2v-5h-2v5Z"></path>
          </svg>
        </button>
      </div>
    </>
